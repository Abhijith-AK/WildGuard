...
def cam(id):
    ...
    while(True):
        ...
        if frame_count == (2 * frame_rate):
            ...
            cv2.imwrite("/home/friday/Desktop/Wild_animal_Detection_Mother/Web/static/pic2.png",image_np)

            # image_data = tf.gfile.FastGFile("C:\\Users\\IDZ\\OneDrive\\Desktop\\Early Warning\\Warning_System\\pic.jpg",
            image_data = tf.io.gfile.GFile("/home/friday/Desktop/Wild_animal_Detection_Mother/Web/static/pic2.png",
                                            'rb').read()
